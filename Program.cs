      ...
      for (int _x = -15; _x < 16; _x++)
      {
        for (int _z = -15; _z < 16; _z++)
        {
          for (int _y = -15; _y < 16; _y++)
          {
            ...
            if (world[_x + x, _y + y, _z + z] == 1) { texup = texture_grass; texside = texture_grassside; texdown = texture_dirt; }
            if (world[_x + x, _y + y, _z + z] == 2) { texup = texture_dirt; texside = texture_dirt; texdown = texture_dirt; }
            if (world[_x + x, _y + y, _z + z] == 3) { texup = texture_stone; texside = texture_stone; texdown = texture_stone; }
            if (world[_x + x, _y + y, _z + z] == 4) { texup = texture_log; texside = texture_logside; texdown = texture_log; }
            if (world[_x + x, _y + y, _z + z] == 5) { texup = texture_sand; texside = texture_sand; texdown = texture_sand; }
            if (world[_x + x, _y + y, _z + z] == 7) { texup = texture_bedrock; texside = texture_bedrock; texdown = texture_bedrock; }
            if (world[_x + x, _y + y, _z + z] == 8) { texup = texture_planks; texside = texture_planks; texdown = texture_planks; }
            if (world[_x + x, _y + y, _z + z] == 11) { texup = texture_coalore; texside = texture_coalore; texdown = texture_coalore; }
            if (world[_x + x, _y + y, _z + z] == 12) { texup = texture_ironore; texside = texture_ironore; texdown = texture_ironore; }
            if (world[_x + x, _y + y, _z + z] == 14) { texup = texture_craft; texside = texture_craftside; texdown = texture_planks; }
      ...
      for (int _x = -15; _x < 16; _x++)
      {
        for (int _z = -15; _z < 16; _z++)
        {
          for (int _y = -15; _y < 16; _y++)
          {
            ...
            if (world[_x + x, _y + y, _z + z] == 6) { texup = texture_leaves; texside = texture_leaves; texdown = texture_leaves; }
            if (world[_x + x, _y + y, _z + z] == 9) { texup = texture_water; texside = new Texture2D(); texdown = new Texture2D(); }
            if (world[_x + x, _y + y, _z + z] == 10) { texup = texture_glass; texside = texture_glass; texdown = texture_glass; }
            if (world[_x + x, _y + y, _z + z] == 13) { texup = texture_lava; texside = new Texture2D(); texdown = new Texture2D(); }
